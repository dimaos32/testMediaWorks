...
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
...
Object(_modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["initMobileMenu"])();
...
var mobileMenuBreakpoint = window.matchMedia('(min-width: 768px)');
...
var initMobileMenu = function initMobileMenu() {
  ...
  var list = nav.querySelector('.main-nav__list');
  var overlay = nav.querySelector('.main-nav__overlay');
  ...
  var onLinkClick = function onLinkClick(_ref) {
    var target = _ref.target;
    var link = target.closest('.main-nav__link');
...
var modalAuthorization = document.querySelector('.modal--authorization');
var modalAuthorizationBtns = document.querySelectorAll('[data-modal="authorization"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalAuthorization && modalAuthorizationBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalAuthorization, false, modalAuthorizationBtns, false, false);
  }
};
